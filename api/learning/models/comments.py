...
class Comment(ModelApi):
    ...
    course = models.ForeignKey('learning.Course', on_delete=models.CASCADE, blank=True, null=True, verbose_name='etapa')
    lesson = models.ForeignKey('learning.Lesson', on_delete=models.CASCADE, blank=True, null=True, verbose_name='clase')
