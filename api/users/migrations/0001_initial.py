# Generated by Django 4.1.6 on 2023-02-13 20:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_number', models.CharField(max_length=23)),
                ('phone_number', models.CharField(blank=True, max_length=500, null=True)),
                ('type_user', models.CharField(choices=[('ADM', 'administrator'), ('STU', 'estudiante')], max_length=3)),
